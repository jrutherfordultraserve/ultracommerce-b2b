...
import com.broadleafcommerce.account.service.type.AccountOrderStatus;
...
public class OrderHistoryController extends BroadleafOrderHistoryController {
    ...
    public String viewOrderHistory(HttpServletRequest request, Model model) {
        String view = super.viewOrderHistory(request, model);

        List pendingOrders = orderService.findOrdersForCustomer(CustomerState.getCustomer(), AccountOrderStatus.PENDING_APPROVAL);
