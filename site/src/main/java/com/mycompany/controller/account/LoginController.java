...
public class LoginController extends BroadleafLoginController {
    ...
    @RequestMapping(value = "/login/forcedPasswordChange", method = RequestMethod.GET)
    public String processForcedPasswordChange(HttpServletRequest request, HttpServletResponse response, Model model) {
        return super.forcedPasswordChange(request, response, model);
    }
    
    @RequestMapping(value = "/login/forcedPasswordChange", method = RequestMethod.POST)
    public String processForcedPasswordChange(@RequestParam("emailAddress") String emailAddress, HttpServletRequest request, Model model) {
        return super.processForcedPasswordChange(emailAddress, request, model);
    }
